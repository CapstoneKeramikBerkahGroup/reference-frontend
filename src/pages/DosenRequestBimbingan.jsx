      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            <div className="h-16 w-16 bg-gradient-to-br from-red-600 to-red-700 rounded-lg flex items-center justify-center">
              <UserCheck className="h-8 w-8 text-white" />
            </div>
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Request Pembimbingan</h1>
        ...
        <Tabs defaultValue="pending" className="w-full">
          <TabsList className="grid w-full grid-cols-3 mb-6">
            ...
            <TabsTrigger value="bimbingan" className="relative">
              Mahasiswa Bimbingan
              {myBimbingan.length > 0 && (
                <Badge className="ml-2 bg-blue-600">{myBimbingan.length}</Badge>
              )}
            </TabsTrigger>
          </TabsList>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <CardTitle className="text-lg">{request.mahasiswa_nama}</CardTitle>
                    ...
                    <CardContent>
                      {request.pesan_mahasiswa && (
                        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                          <p className="text-sm font-medium text-gray-700 mb-1">Pesan Mahasiswa:</p>
                          <p className="text-sm text-gray-600 italic">&quot;{request.pesan_mahasiswa}&quot;</p>
                        </div>
                      )}
                    ...
                    <CardContent>
                      ...
                      {request.pesan_dosen && (
                        <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                          <p className="text-sm font-medium text-blue-800 mb-1">Respon Anda:</p>
                          <p className="text-sm text-blue-700 italic">&quot;{request.pesan_dosen}&quot;</p>
                        </div>
                      )}
                    </CardContent>
                  </Card>
                    ...
                    <Card key={mhs.id} className="hover:shadow-md transition-shadow">
                      <CardHeader>
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            <CardTitle className="text-lg">{mhs.nama}</CardTitle>
                            <CardDescription>NIM: {mhs.nim}</CardDescription>
                          </div>
                        </div>
                      </CardHeader>
                      <CardContent>
